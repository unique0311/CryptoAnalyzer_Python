...
from ml.trials.trial_2_detect_plaintext_type_from_shift_cipher_singlekey import trial_2_detect_plaintext_type_from_shift_cipher_singlekey
from ml.trials.trial_3_detect_plaintext_type_from_xor_cipher_singlekey import  trial_3_detect_plaintext_type_from_xor_cipher_singlekey
...
from ml.trials.trial_10_detect_plaintext_type_with_shift_short_changing_key import  trial_10_detect_plaintext_type_with_shift_short_changing_key
from ml.trials.trial_11_rnn_detect_plaintext_type_from_shift_cipher_singlekey import  trial_11_rnn_detect_plaintext_type_from_shift_cipher_singlekey

"""
A dictionary of the menu options
You can choose one trial.
"""
MENU_OPTIONS = {
...
def Get_User_Selection(menu_options):
    ...
    """
    try:
        user_input_str = input("Enter your trial choice: ")
        ...
        print("Error converting str to int. Please try again!!!")
        return -1
...
def main():
    ...
    """
    print("******************************************")
    print("Machine Learning Cypto-Analyzer by " + username )
    print("******************************************")

    menu_items_keys = list(MENU_OPTIONS.keys())
    menu_items_model = list(MENU_OPTIONS.values())
    ...
    while True:
        ...
        if not selection == -1:
            func = menu_items_model[selection - 1]
            func()
            print()
